...
<section class="pt-6 bg-white dark:bg-gray-900 mb-32 ">
    <div class="container px-4">
        <!-- Back btn -->
        <div>
            <a href="{{ route('jobs') }}" class="group py-3 inline-flex items-center gap-x-1 text-base font-medium rounded-lg border border-transparent text-gray-800 hover:text-blue-600 focus:outline-hidden focus:text-blue-800 active:text-blue-800 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:text-blue-400 dark:focus:text-blue-400 dark:active:text-blue-400">
                <svg class="h-4 w-4 transition-transform duration-300 group-hover:-translate-x-1" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
                Back to Jobs
            </a>
        </div>
